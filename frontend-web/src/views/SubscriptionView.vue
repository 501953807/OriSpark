...
.tier-price { font-weight: 700; font-size: 1.1rem; color: rgb(140, 87, 255); white-space: nowrap; }
...
.feature-tag {
  ...
  background: rgba(var(--m-success-rgb, 86, 202, 0), 0.08); color: rgb(140, 87, 255); font-weight: 500;
}
