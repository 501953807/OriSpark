...
.subtitle { color: var(--m-grey-500); margin-bottom: 16px; }
.tabs { display: flex; gap: 4px; border-bottom: 1px solid var(--m-border); margin-bottom: 20px; overflow-x: auto; }
...
.loading-text { text-align: center; padding: 40px; color: var(--m-grey-500); }
