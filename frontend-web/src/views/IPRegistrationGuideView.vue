...
.recommend-rank { font-size: 1.2rem; font-weight: 700; color: var(--m-primary); min-width: 24px; }
...
.step-item.done:not(:last-child)::after { background: var(--m-primary); }
.step-dot {
...
.step-item.active .step-dot, .step-item.done .step-dot { border-color: var(--m-primary); background: var(--m-primary); color: #fff; }
...
.form-textarea:focus { border-color: var(--m-primary); }
