    ...
    <div v-if="activeTab === 'products'" class="tab-panel">
      ...
      <div v-if="showProductForm" class="form-card">
        ...
        <div class="form-grid">
          ...
          <input
            v-model.number="productForm.moq"
            type="number"
            class="form-input"
            placeholder="MOQ"
          />
          ...
          />
          <input
            v-model.number="productForm.production_time_days"
            type="number"
            class="form-input"
            placeholder="生产周期 (天)"
          />
    ...
    <div v-if="activeTab === 'factories'" class="tab-panel">
      ...
      <div v-if="showFactoryForm" class="form-card">
        ...
        <div class="form-grid">
          ...
          <input
            v-model.number="factoryForm.rating"
            type="number"
            step="0.1"
            min="0"
            max="5"
    ...
    <div v-if="activeTab === 'rfqs'" class="tab-panel">
      ...
      <div v-if="showRfqForm" class="form-card">
        ...
        <div class="form-grid">
          ...
          <textarea
            v-model="rfqForm.description"
            class="form-input form-textarea"
            placeholder="描述"
            rows="3"
          />
          <input
            v-model.number="rfqForm.quantity_needed"
            type="number"
            class="form-input"
            placeholder="需求数量"
          />
          <input
            v-model.number="rfqForm.target_price"
            type="number"
            class="form-input"
            placeholder="目标单价 (&yen;)"
          />
        ...
        <div v-for="o in store.orders" :key="o.id" class="order-card">
          ...
          <div class="order-steps">
            <span class="step-group">
              <span
                :class="['step-dot', { done: orderStepDone(0, o) }]"
              />
            ...
            <span class="step-group">
              <span
                :class="['step-dot', { done: orderStepDone(1, o) }]"
              />
            ...
            <span class="step-group">
              <span
                :class="['step-dot', { done: orderStepDone(2, o) }]"
              />
            ...
            <span class="step-group">
              <span
                :class="['step-dot', { done: orderStepDone(3, o) }]"
              />
...
const craftTypes: CraftType[] = [
  'embroidery', 'ceramics', 'woodcarving', 'weaving', 'pottery', 'other',
]
...
function badgeClass(ct: CraftType): string {
  return ct || 'other'
}
...
const rfqForm = reactive({
  title: '',
  description: '',
  quantity_needed: undefined as number | undefined,
...
function statusLabel(s: RFQStatus): string {
...
async function handleCreateRFQ() {
  ...
  try {
    await store.createRFQ({
      ...
      quantity_needed: rfqForm.quantity_needed,
      target_price: rfqForm.target_price,
      status: rfqForm.status,
    })
    ;(window as any).$toast?.show('询价单创建成功', 'success')
    Object.assign(rfqForm, {
      title: '',
      description: '',
