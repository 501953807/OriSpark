...
.btn-add:hover { border-color: var(--m-primary); }
...
.btn-confirm { background: var(--m-primary); color: white; border: none; padding: 8px 16px; border-radius: var(--m-radius-sm); cursor: pointer; font-size: 0.85rem; }
...
.cover-hint { font-size: 0.8rem; color: var(--m-grey-500); margin: 0; }
