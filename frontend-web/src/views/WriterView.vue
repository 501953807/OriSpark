...
.stat-item { padding: 16px 20px; text-align: center; background: var(--m-surface); border: 1px solid var(--m-border); border-radius: var(--m-radius-md); }
...
.tab-btn.active { background: var(--m-primary); color: #fff; border-color: var(--m-primary); }
...
.form-select:focus { border-color: var(--m-primary); }

/* ── Card Grid ─────────────────────────────────────────────────── */
.card-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 14px; }
.card { padding: 18px 20px; background: var(--m-surface); border: 1px solid var(--m-border); border-radius: var(--m-radius-md); display: flex; flex-direction: column; gap: 10px; }
...
.ms-book-link { font-size: 0.78rem; color: var(--m-primary); cursor: pointer; text-decoration: underline; }
