...
function tickParticles() {
  ...
  for (const p of particles.value) {
    ...
    canvasCtx!.fillStyle = `rgba(var(--m-primary-rgb, 79, 70, 229), ${p.life * 0.5})`
    canvasCtx!.fill()
  }
...
.card-level-2:not(.reduced-motion):hover {
  border: 1px solid rgba(var(--m-primary-rgb, 79, 70, 229), 0.45);
  box-shadow: 0 0 16px rgba(var(--m-primary-rgb, 79, 70, 229), 0.2), 0 8px 24px rgba(0,0,0,1);
}
