...
.campaign-card { border: 1px solid #e5e7eb; border-radius: var(--m-radius-md, 12px); padding: 16px; }
...
.progress-bar { height: 4px; background: #e5e7eb; border-radius: var(--m-radius-xs, 6px); overflow: hidden; }
.progress-fill { height: 100%; background: #3b82f6; transition: width 0.3s; }
.card-actions { display: flex; gap: 8px; margin-top: 12px; }
.card-actions button { padding: 4px 12px; border: 1px solid #d1d5db; border-radius: var(--m-radius-xs, 6px); background: #fff; cursor: pointer; font-size: 13px; }
...
.form-card { background: #fff; border-radius: var(--m-radius-md, 12px); padding: 24px; min-width: 300px; }
