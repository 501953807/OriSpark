...
.stat-value { font-size: 1.5rem; font-weight: 700; color: rgb(140, 87, 255); }
...
.partner-type { font-size: 0.82rem; color: var(--m-grey-500); margin-top: 4px; }
...
.notif-item.unread { border-left: 3px solid rgb(140, 87, 255); }
