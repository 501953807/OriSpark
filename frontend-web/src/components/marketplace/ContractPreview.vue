...
<style scoped>
.contract-body { background: #fafafa; padding: 20px; border-radius: var(--m-radius-md, 12px); margin-bottom: 16px; }
...
.days-badge { padding: 2px 8px; border-radius: var(--m-radius-md, 12px); font-size: 0.75rem; background: #fef3c7; }
