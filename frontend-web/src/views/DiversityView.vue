...
.chart-section { background: var(--m-surface); border: 1px solid var(--m-border); border-radius: var(--m-radius-sm); padding: 20px; margin-bottom: 24px; }
...
.btn-primary { background: var(--m-primary); color: white; border: none; padding: 8px 20px; border-radius: var(--m-radius-sm); cursor: pointer; font-size: 0.9rem; }
